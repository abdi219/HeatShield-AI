...
export function WhatIfSimulator() {
  ...
  return (
    <div
      className={`w-80 md:w-[340px] p-4 rounded-2xl space-y-3.5 shadow-2xl overflow-y-auto max-h-[calc(100vh-100px)] scrollbar-thin ${glassCard}`}
    >
      {/* ── 1. Header ── */}
      ...
      {/* ── 5. Real-Time Telemetry Impact Card ── */}
      {simulationResult && (
