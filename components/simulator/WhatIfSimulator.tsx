  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center justify-between pb-2.5 border-b ${border}`}>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className={`px-2 py-1 rounded-lg border text-xs font-bold transition-all flex items-center gap-1 ${isSatellite
          ...
          <div className="flex items-center justify-between text-[10px] font-mono pt-1 border-t border-white/10">
            ...
            <div className="flex items-center gap-1.5">
              <button
                type="button"
                onClick={handleResetBaseline}
                className={`px-1.5 py-0.5 rounded-md text-[10px] font-bold border transition-all ${isSatellite ? "bg-white/10 text-white border-white/20" : "bg-slate-100 text-slate-700 border-slate-200"
                  }`}
              >
                Reset
              </button>
              <button
                ...
                className={`px-2 py-0.5 rounded-md text-[10px] font-bold border transition-all ${isSatellite ? "bg-white text-slate-950 font-black shadow-sm" : "bg-slate-900 text-white font-bold shadow-sm"
                  }`}
              >
                Controls ▲
              </button>
      ...
      <div className={`${isMobileMinimized ? "hidden md:block" : "block"} space-y-3.5`}>
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              ...
              className={`px-2.5 py-2 rounded-xl text-left border transition-all flex flex-col gap-0.5 ${isSatellite
                  ? "bg-white/10 hover:bg-white/20 text-white border-white/25"
        ...
        {simulationResult && (
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className={`p-3 rounded-xl border flex flex-col justify-between ${isSatellite ? "bg-emerald-500/20 border-emerald-400/40" : "bg-emerald-50 border-emerald-200"
                }`}>
              ...
              <div className={`p-3 rounded-xl border flex flex-col justify-between ${isSatellite ? "bg-sky-500/20 border-sky-400/40" : "bg-sky-50 border-sky-200"
                }`}>
                <div className="flex items-center justify-between">
            ...
            {(["mitigated", "baseline", "delta"] as const).map((mode) => {
              ...
              return (
                <button
                  ...
                  className={`py-1.5 rounded-lg text-[10px] font-mono font-bold border transition-all text-center ${active
                      ? isSatellite
        ...
        <div className="space-y-2 pt-1 border-t border-white/10">
          <div className="flex gap-1.5">
            <button
              ...
              className={`flex-1 py-1.5 px-2.5 rounded-xl border text-[10px] font-bold transition-all flex items-center justify-center gap-1.5 ${isSaving
            ...
            <button
              ...
              className={`flex-1 py-1.5 px-2.5 rounded-xl border text-[10px] font-bold transition-all flex items-center justify-center gap-1.5 ${copiedReport
          ...
          {isSaving && (
            <form onSubmit={handleSaveScenario} className="flex items-center gap-1.5 pt-1">
              <input
                ...
                className={`flex-1 px-2.5 py-1.5 text-xs rounded-xl border focus:outline-none transition-all ${isSatellite
              ...
              <button
                ...
                className={`p-1.5 rounded-xl border text-xs font-bold transition-all ${isSatellite
                    ? "bg-white/10 hover:bg-white/20 text-white border-white/25"
          ...
          {savedScenarios.length > 0 && (
            <div className="space-y-1 pt-1">
              <button
                ...
                className={`w-full py-1 px-2 rounded-lg text-[10px] font-mono font-bold flex items-center justify-between border ${isSatellite ? "bg-white/5 border-white/15 text-white/80" : "bg-slate-50 border-slate-200 text-slate-600"
                  }`}
              >
              ...
              {isSavedDrawerOpen && (
                <div className="space-y-1 max-h-32 overflow-y-auto scrollbar-thin">
                  {savedScenarios.map((scen) => (
                    <div
                      key={scen.id}
                      className={`p-1.5 rounded-lg border flex items-center justify-between text-xs ${isSatellite ? "bg-white/10 border-white/20 text-white" : "bg-slate-100 border-slate-200 text-slate-800"
                        }`}
                    >
                      <button
                        type="button"
        ...
        <div className={`p-2 rounded-xl text-[9px] leading-tight flex items-start gap-1.5 opacity-75 ${isSatellite ? "bg-white/5 border border-white/15 text-white/70" : "bg-slate-50 border border-slate-200 text-slate-500"
          }`}>
